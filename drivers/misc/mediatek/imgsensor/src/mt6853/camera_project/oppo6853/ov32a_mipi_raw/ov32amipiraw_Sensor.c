...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.margin = 14,
	.min_shutter = 8,        //min shutter check
	.min_gain = 64, /*1x gain*/
	.max_gain = 992, /*15.5 gain*/
	.min_gain_iso = 100,
	.gain_step = 1,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{ 6528, 4896,    0,    0, 6528, 4896, 3264, 2448, 0,    0,   3264, 2448,    0,    0, 3264, 2448},//normal-video
	{ 6528, 4896,    0,    0, 6528, 4896, 3264, 2448, 0,    0,   3264, 2448,    0,    0, 3264, 2448},//hs_video
	...
	{ 6528, 4896,    0,    0, 6528, 4896, 3264, 2448, 0,    306, 3264, 1836,    0,    0, 3264, 1836},//custom4
	{ 6528, 4896,    0,    0, 6528, 4896, 1632, 1224, 0,    0,   1632, 1224,    0,    0, 1632, 1224},//custom5
};
...
#ifdef VENDOR_EDIT
static kal_uint16 ov32a1q_burst_write_cmos_sensor(
					kal_uint16 *para, kal_uint32 len)
{
	char puSendCmd[I2C_BUFFER_LEN];
	kal_uint32 tosend, IDX;
...
static void read_eeprom_xtalk(void)
{
	kal_uint16 idx = 0, eeprom_xtalk_addr = 0x0c90, sensor_xtalk_addr = 0x53C0;

	for (idx = 0; idx <288; idx++) {
		eeprom_xtalk_addr = 0x0c90 + idx;
		sensor_xtalk_addr = 0x53C0 + idx;
		ov32a_xtalk_setting[2*idx] = sensor_xtalk_addr;
		ov32a_xtalk_setting[2*idx + 1] = read_cmos_eeprom_8(eeprom_xtalk_addr);
	}
}

static void write_sensor_xtalk(void)
{
	ov32a1q_burst_write_cmos_sensor(ov32a_xtalk_setting,sizeof(ov32a_xtalk_setting)/sizeof(kal_uint16));
}

static kal_uint8 gOV32A_SN[CAMERA_MODULE_SN_LENGTH];
static void read_eeprom_SN(void)
{
	kal_uint16 idx = 0;
	kal_uint8 *get_byte= &gOV32A_SN[0];
	for (idx = 0; idx <CAMERA_MODULE_SN_LENGTH; idx++) {
		...
		LOG_INF("gOV32A_SN[%d]: 0x%x  0x%x\n", idx, get_byte[idx], gOV32A_SN[idx]);
	}
}
...
static void read_eeprom_CamInfo(void)
{
	...
	for (idx = 0; idx <12; idx++) {
		...
		iReadRegI2C(pusendcmd , 2, (u8*)&get_byte[idx],1, 0xA8);
		LOG_INF("OV32A_info[%d]: 0x%x\n", idx, get_byte[idx]);
	}

	gOV32A_CamInfo[0] = get_byte[0];
	gOV32A_CamInfo[1] = get_byte[1];
	gOV32A_CamInfo[2] = get_byte[6];
	gOV32A_CamInfo[3] = get_byte[7];
	gOV32A_CamInfo[4] = get_byte[8];
	gOV32A_CamInfo[5] = get_byte[9];
	gOV32A_CamInfo[6] = get_byte[10];
	gOV32A_CamInfo[7] = get_byte[11];
}
...
kal_uint16 addr_data_pair_init_ov32a1q[] = {
	0x0103, 0x01,
	0x0102, 0x01,
	0x0302, 0x31,
	0x0323, 0x05,
...
//xtalk step2
kal_uint16 addr_data_pair_init2_ov32a1q[] = {
	0x5500, 0x82,
	0x5501, 0x89,
	0x5502, 0x88,
	0x5503, 0x8a,
...
static void sensor_init(void) //check out
{
	...
	ov32a1q_table_write_cmos_sensor(
		...
		sizeof(addr_data_pair_init_ov32a1q) /sizeof(kal_uint16));
	ov32a1q_burst_write_cmos_sensor(
		addr_data_pair_init2_ov32a1q,
		sizeof(addr_data_pair_init2_ov32a1q)/sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_preview_ov32a1q[] = {
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
kal_uint16 addr_data_pair_capture_ov32a1q[] = {
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
kal_uint16 addr_data_pair_normal_video_ov32a1q[] = {
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
kal_uint16 addr_data_pair_hs_video_ov32a1q[] = {
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
kal_uint16 addr_data_pair_slim_video_ov32a1q[] = {
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
kal_uint16 addr_data_pair_custom1_ov32a1q[] = {
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
kal_uint16 addr_data_pair_custom2_ov32a1q[] = {
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
kal_uint16 addr_data_pair_custom3_ov32a1q[] = {
	0x0305, 0x3f,
	0x0344, 0x01,
	0x0345, 0xce,
	0x034a, 0x0a,
...
kal_uint16 addr_data_pair_custom4_ov32a1q[] = {
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
kal_uint16 addr_data_pair_custom5_ov32a1q[] = {
	0x0305, 0x64,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x05,
...
static void custom5_setting(void)
{
	LOG_INF("E\n");
	ov32a1q_table_write_cmos_sensor(
		addr_data_pair_custom5_ov32a1q,
		sizeof(addr_data_pair_custom5_ov32a1q) /
		sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	printk("chenshipei, ov32a get_sensor_id enter!");
			...
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if (deviceInfo_register_value == 0x00) {
					register_imgsensor_deviceinfo("Cam_f0", DEVICE_VERSION_OV32A1Q, imgsensor_info.module_id);
			...
			MUINT32 framerate)
{
	...
	break;
	case MSDK_SCENARIO_ID_CUSTOM5:
		frameHeight = imgsensor_info.custom5.pclk /
			framerate * 10 / imgsensor_info.custom5.linelength;
		spin_lock(&imgsensor_drv_lock);
		imgsensor.dummy_line =
			(frameHeight > imgsensor_info.custom5.framelength) ?
