...
unsigned int gps_dl_osal_strlen(const char *str);
int gps_dl_osal_strcmp(const char *dst, const char *src);
int gps_dl_osal_strncmp(const char *dst, const char *src, unsigned int len);
char *gps_dl_osal_strcpy(char *dst, const char *src);
char *gps_dl_osal_strncpy(char *dst, const char *src, unsigned int len);
char *gps_dl_osal_strcat(char *dst, const char *src);
char *gps_dl_osal_strncat(char *dst, const char *src, unsigned int len);
char *gps_dl_osal_strchr(const char *str, unsigned char c);
char *gps_dl_osal_strsep(char **str, const char *c);
int gps_dl_osal_strtol(const char *str, unsigned int adecimal, long *res);
int gps_dl_osal_snprintf(char *buf, unsigned int len, const char *fmt, ...);
int gps_dl_osal_err_print(const char *str, ...);
int gps_dl_osal_dbg_print(const char *str, ...);
int gps_dl_osal_warn_print(const char *str, ...);
void *gps_dl_osal_malloc(unsigned int size);
void gps_dl_osal_free(const void *dst);
void *gps_dl_osal_memset(void *buf, int i, unsigned int len);
void *gps_dl_osal_memcpy(void *dst, const void *src, unsigned int len);
void gps_dl_osal_memcpy_fromio(void *dst, const void *src, unsigned int len);
void gps_dl_osal_memcpy_toio(void *dst, const void *src, unsigned int len);
int gps_dl_osal_memcmp(const void *buf1, const void *buf2, unsigned int len);
