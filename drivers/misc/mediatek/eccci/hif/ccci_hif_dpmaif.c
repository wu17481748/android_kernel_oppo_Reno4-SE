...
//Qixin.Xiang@PSW.NW.DATA.2615482, 2019/12/7
//Add AP patch ALPS04906513 for ccci issue
//#ifdef VENDOR_EDIT
	//if (ret < 0) {
//#if defined(CONFIG_MTK_AEE_FEATURE)
	...
	struct dpmaifq_normal_pit *pkt_inf_t)
{
    ...
    //#ifdef VENDOR_EDIT
    //yongpeng.huang@PSW.NW.2707169, 2019/12/26
    //modify according to patch(debug&workaround, ALPS04944418) from mtk
    if (new_skb == NULL) {
        CCCI_NORMAL_LOG(dpmaif_ctrl->md_id, TAG,
