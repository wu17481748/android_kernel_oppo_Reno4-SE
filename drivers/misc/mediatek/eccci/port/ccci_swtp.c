...
//#ifdef VENDOR_EDIT
//Fei.Yang@RM.NW.RF ,2020/08/12 MTK Case ALPS05263523, REQ30006377748
//Add for sovle the mt6853 recognition eint_type fail as the code analysis 4 element
//the mt6853 interrupts = <72 IRQ_TYPE_LEVEL_HIGH>;the interrupts have 2 element
//the mt6889 interrupts = <72 IRQ_TYPE_LEVEL_HIGH 72 0>;the interrupts have 4 element
...
//#else
		...
		if (ret)
			CCCI_LEGACY_ERR_LOG(md_id, SYS,
				"%s get property:interrupts,ret=%d\n",
				__func__, ret);
//#endif  /*VENDOR_EDIT*/
