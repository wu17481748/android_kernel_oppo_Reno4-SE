...
#include "charger_ic/oppo_battery_mtk6853.h"
#endif
...
#elif defined CONFIG_OPPO_SM7125_CHARGER
#include "charger_ic/oppo_battery_msm7125_Q.h"
...
#define SMART_ENTER_USBTEMP_LIMIT_CHARGER 		0X10000
#define SMART_EXIT_USBTEMP_LIMIT_CHARGER 		0X20000
#define SMART_CHARGE_USER_USBTEMP	1
#define SMART_CHARGE_USER_OTHER		0
#define USBTEMP_LIMIT_INPUT_CURRENT	3000
...
struct oppo_chg_limits {
	...
	int usbtemp_input_current_vooc_ma_normal;
	int iterm_ma;
	bool iterm_disabled;
	int recharge_mv;
...
/*	struct battery_data battery_main	*/
	...
	int *con_temp;
	int len_array;
	wait_queue_head_t oppo_usbtemp_wq;
...
struct oppo_chg_operations {
	void (*get_usbtemp_volt)(struct oppo_chg_chip *chip);
	void  (*set_typec_sinkonly)(void);
	bool (*oppo_usbtemp_monitor_condition)(void);
