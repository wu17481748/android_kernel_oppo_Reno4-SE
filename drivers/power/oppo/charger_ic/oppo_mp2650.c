...
void __attribute__((weak)) oppo_set_typec_sinkonly(void)
{
	return;
}

void __attribute__((weak)) oppo_get_usbtemp_volt(struct oppo_chg_chip *chip)
{
	return;
}

bool __attribute__((weak)) oppo_usb_or_otg_is_present(void)
{
	return false;
}
struct oppo_chg_operations  mp2650_chg_ops = {
    ...
    .get_ibus = mp2650_get_ibus_current,
    ...
    .oppo_chg_wdt_enable = mp2650_wdt_enable,
