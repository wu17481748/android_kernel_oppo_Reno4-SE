...
#ifdef VENDOR_EDIT /*jiangshunzhou 2020/6/29 add for wakelock debug*/
void oppo_pm_get_active_wakeup_sources(char *pending_wakeup_source, size_t max)
{
	struct wakeup_source *ws;
	int len = 0;
...
EXPORT_SYMBOL_GPL(oppo_pm_get_active_wakeup_sources);
#endif /*VENDOR_EDIT*/
